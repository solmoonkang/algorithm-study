...
public class 가채점 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "tentativeScoring = " +
                Arrays.toString(tentativeScoring.solution(numbers1, our_score1, score_list1))
        );

        System.out.println(
                "tentativeScoring = " +
                        Arrays.toString(tentativeScoring.solution(numbers2, our_score2, score_list2))
        );
    }
}
