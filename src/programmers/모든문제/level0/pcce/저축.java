...
public class 저축 {
     ...
     * 첫 달에 일정 금액을 넣은 뒤 70만 원까지는 매월 조금씩 저축하다가 70만 원 이후부터는
    ...
    public static void main(String[] args) {
        ...
        int start = sc.nextInt();   // 첫 달에 저축하는 금액
        int before = sc.nextInt();  // 70이 모일 때까지 매월 저축하는 금액
        int after = sc.nextInt();   // 100이상 모일 때까지 매월 저축하는 금액
