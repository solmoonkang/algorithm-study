...
public class 바탕화면정리 {
    ...
    public int[] solution(String[] wallpaper) {
        // TODO: 전반적으로 잘 풀긴 했음. 그래도 다시 한 번 풀어보자.
    ...
    public static void main(String[] args) {
        바탕화면정리 cleanUpDesktop = new 바탕화면정리();

        String[] firstWallpaper = {".#...", "..#..", "...#."};
        System.out.println("cleanUpDesktop = " +
                Arrays.toString(cleanUpDesktop.solution(firstWallpaper)));

        String[] secondWallpaper = {"..........", ".....#....",
                "......##..", "...##.....", "....#....."};
        System.out.println("cleanUpDesktop = " +
                Arrays.toString(cleanUpDesktop.solution(secondWallpaper)));

        String[] thirdWallpaper = {".##...##.", "#..#.#..#", "#...#...#",
                ".#.....#.", "..#...#..", "...#.#...", "....#...."};
        System.out.println("cleanUpDesktop = " +
                Arrays.toString(cleanUpDesktop.solution(thirdWallpaper)));

        String[] fourthWallpaper = {"..", "#."};
        System.out.println("cleanUpDesktop = " +
                Arrays.toString(cleanUpDesktop.solution(fourthWallpaper)));
    }
}
