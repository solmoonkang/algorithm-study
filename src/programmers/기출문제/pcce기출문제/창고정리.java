...
public class 창고정리 {
    ...
    public static void main(String[] args) {
        창고정리 warehouseOrganization = new 창고정리();

        String[] firstStorage = {"pencil", "pencil", "pencil", "book"};
        int[] firstNum = {2, 4, 3, 1};
        System.out.println("warehouseOrganization = " +
                warehouseOrganization.solution(firstStorage, firstNum));

        String[] secondStorage = {"doll", "doll", "doll", "doll"};
        int[] secondNum = {1, 1, 1, 1};
        System.out.println("warehouseOrganization = " +
                warehouseOrganization.solution(secondStorage, secondNum));

        String[] thirdStorage = {"apple", "steel", "leaf", "apple", "leaf"};
        int[] thirdNum = {5, 3, 5, 3, 7};
        System.out.println("warehouseOrganization = " +
                warehouseOrganization.solution(thirdStorage, thirdNum));

        String[] fourthStorage = {"mirror", "net", "mirror", "net", "bottle"};
        int[] fourthNum = {4, 1, 4, 1, 5};
        System.out.println("warehouseOrganization = " +
                warehouseOrganization.solution(fourthStorage, fourthNum));
    }
}
