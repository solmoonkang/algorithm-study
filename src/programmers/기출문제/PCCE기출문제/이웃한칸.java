...
public class 이웃한칸 {
    ...
    public int solution(String[][] board, int h, int w) {
        // TODO: 문제에서 지정한대로 진행만 했음. 아직도 배열을 다루는 문제는 미숙함. 관련 문제들을 더 풀어보자.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("adjacentCell = " + adjacentCell.solution(firstBoard, 1, 1));
        ...
        System.out.println("adjacentCell = " + adjacentCell.solution(secondBoard, 0, 1));
    }
}
