...
public class 비밀지도 {
    ...
    public String[] solution(int n, int[] arr1, int[] arr2) {
        // TODO: toBinaryString 메서드 활용법에 대해 배웠음. format 메서드는 자주 사용하지 않아 추가로 알아보자.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("secretMap = " + Arrays.toString(secretMap.solution(5, firstArr1, firstArr2)));

        int[] secondArr1 = {46, 33, 33 ,22, 31, 50};
        int[] secondArr2 = {27 ,56, 19, 14, 14, 10};
        System.out.println("secretMap = " + Arrays.toString(secretMap.solution(6, secondArr1, secondArr2)));
    }
}
