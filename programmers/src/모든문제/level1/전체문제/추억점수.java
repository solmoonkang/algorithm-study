...
public class 추억점수 {
     ...
     * 사진들의 추억 점수를 photo에 주어진 순서대로 배열에 담아 반환하라.
     */
    public int[] solution(String[] name, int[] yearning, String[][] photo) {
        ...
        for (int i = 0; i < photo.length; i++) {
            for (String person : photo[i]) {
                scores[i] += hashMap.getOrDefault(person, 0);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        String[][] photo = {
                ...
                {"may", "kein", "brin", "deny"},
                {"kon", "kain", "may", "coni"}};
        System.out.println("Result: " + Arrays.toString(memoriesScore.solution(name, yearning, photo)));
    }
}
